...
```{r}
gapminder %>% 
  mutate(continent=fct_reorder(continent,pop,.fun=mean)) %>%  
...
f<-fct_relevel(gapminder$continent,"Oceania","Asia",after=1)%>% 
  levels() %>% 
  head()
f
...
ggsave("/Users/amitra/Desktop/hw05-malvikamitra1/data/my_plot.png",s,width=13,height=10,units="cm",scale=1,dpi=400)

```
![Alt text](/Users/amitra/Desktop/hw05-malvikamitra1/data/my_plot.png)
